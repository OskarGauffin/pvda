...
# plot_udfs_as_graph <- function(package_name = "pvutils"){
  ...
  first_call_pos <- pmin(stringr::str_locate(stringr::fixed(code_function_i),
  ...
  edges <- dplyr::bind_cols(i, calls |> dplyr::select(-function_name))
...
suppressWarnings(DiagrammeR::render_graph(graph, layout = "tree", title="Overview of package functions"))
