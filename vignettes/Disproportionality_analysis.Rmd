...
The function `da` has a parameter `number_of_digits` controls the rounding of non-count values in the output, including all expected counts, uncertainty bounds and point estimates. Note that the printing defaults of dplyr are not overridden in the package, and less digits than expected may be printed. 
