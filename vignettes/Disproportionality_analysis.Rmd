...
collected through spontaneous reporting plays an instrumental part of the 
saturation of the safety profile.

Given a large set of reports covering a large set of drugs and adverse events, 
...
manual case-by-case assessment. The pvutils package provides three 
disproportionality estimators: the proportional reporting rate (PRR), the 
reporting odds ratio (ROR) and the information component (IC). 
